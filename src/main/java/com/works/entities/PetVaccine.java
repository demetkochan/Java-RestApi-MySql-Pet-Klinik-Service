...
public class PetVaccine {
    ...
    @Min(value = 1, message = "Kategori id en küçük 1 olabilir")
    @ApiModelProperty(value = "Kategori id")
    private int category_group_cg_id;


    @Min(value = 1, message = "Tedarikçi id en küçük 1 olabilir")
    ...
    @Min(value = 1, message = "Pet aşı alış fiyatı en küçük 1 olabilir")
